...
#   (think of it as a safe zone for our little turtle). Hint: generate 
#   a new car only every 6th time the game loop runs.

# TODO Detect when the turtle player collides with a car and stop the game 
#   if this happens.
